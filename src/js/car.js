      ...
      return `
            <ul class="order_lists order_item" gid=${item.good_id}>
                ...
                <li class="list_con">
                  ...
                  <div class="list_text"><a href="./detail.html?product/${item.good_id}">${item.p2}</a></div>
                </li>
                <li class="list_price">
                  <p class="price">￥${item.p1.slice(1)}</p>
                </li>
                ...
                <li class="list_sum">
                  <p class="sum_price" data-price=${item.p1.slice(1)}>￥${Math.round(item.p1.slice(1) * item.num * 100) / 100}</p>
                </li>
                <li class="list_op">
